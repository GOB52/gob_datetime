...
/*
  WARNING 
  There is a problem with the <> format parsing on espressif32@5.2.0 or earlier. (ARDUINO)
*/
// {Location, POSIX}
const std::map<goblib::datetime::string_t, const char*> locationConversionTable = 
{
    {"Africa/Abidjan", "GMT0"},
    {"Africa/Accra", "GMT0"},
    ...
    {"Asia/Tbilisi", "<+04>-4"},
#ifdef ARDUINO
    {"Asia/Tehran", "GMT-03:30GDT-04:30,J79/24,J263/24"},
#else
...
#ifdef ARDUINO
    {"Pacific/Chatham", "CHAST-12:45CHADT-13:45,M9.5.0/2:45,M4.1.0/3:45"},
#else
...
const char* locationToPOSIX(const char* location)
{
    ...
    return  (location && location[0] && locationConversionTable.count(loc) == 1)
            ? locationConversionTable.at(loc) : nullptr;
}
